...
public class Mail {
    ...
    public static String myEmailAccount = "sunjingjun99999@163.com";
    public static String myEmailPassword = "sunjingjun123456";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String context) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "聊天系统", "UTF-8"));
        ...
        message.setContent("您的验证码是："+context, "text/html;charset=UTF-8");
        // 6. 设置发件时间
